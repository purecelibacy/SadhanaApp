...
package org.purecelibacy.sadhana.core.preferences;
...
/*    public static final String DEFAULT_SYNC_SERVER =
    ...
    public static final String DEFAULT_SYNC_SERVER = "http://www.google.com";
    @NonNull
    ...
    public int getDefaultCheckmarkSpinnerPosition()
    {
        int defaultScoreInterval =
                storage.getInt("pref_checkmark_view_interval", 1);

        if (defaultScoreInterval > 5 || defaultScoreInterval < 0)
        {
            defaultScoreInterval = 1;
            storage.putInt("pref_checkmark_view_interval", 1);
        }

        return defaultScoreInterval;
    }

    public void setDefaultCheckmarkSpinnerPosition(int position)
    {
        storage.putInt("pref_checkmark_view_interval", position);
    }
    ...
    {
        return storage.getString("pref_snooze_interval", "15");
    }
    ...
    {
        return storage.getString("pref_sync_key", "KK");
    }
    ...
    {
        return storage.getBoolean("pref_developer", true);
    }
    ...
    public void setFirstName(String firstName) {
        storage.putString("first_name",firstName);
    }
    ...
    public void setLastName(String lastName) {
        storage.putString("last_name",lastName);
    }

    public String getMBACenter() { return storage.getString("mba_center", "");}
    public void setMBACenter(String mbaCenter) {
        storage.putString("mba_center",mbaCenter);
    }

    public String getMahatmaId() { return storage.getString("mahatma_id", "");}
    public void setMahatmaId(String mid) {
        storage.putString("mahatma_id",mid);
    }
